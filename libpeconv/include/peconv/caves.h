...
namespace peconv {
    ...
    /*
    find_ending_cave: finds cave at the end of the image (extend last section's raw size without extending the full image size)
    */
    ...
    /*
    find_alignment_cave: finds cave in the difference between the original raw size, and the raw size rounded to the aligmnent
    */
    ...
    /*
    find_padding_cave: finds cave at the end of the section, that comes from a NULL padding or INT3 padding
    */
